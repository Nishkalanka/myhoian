  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          Авторская экскурсия по Хойану 2024: Туры на русском, цены, бронь
        </title>

        {/* Description: Продающий текст с ключевыми словами и призывом к действию (длина 140-160 символов). */}
        <meta
          name="description"
          content="Индивидуальные экскурсии по Хойану на русском языке. Пешие туры, Лодки-корзины, Кулинарные курсы. Лучшие цены. Бронируйте онлайн!"
        />
        ...
        <meta
          property="og:title"
          content="Авторская экскурсия в Хойане: Туры с MyHoiAn Tours"
        />
        <meta
          property="og:description"
          content="Индивидуальные экскурсии по Хойану на русском языке с Павлом. Пешие туры, Лодки-корзины, Кулинарные курсы."
        />
